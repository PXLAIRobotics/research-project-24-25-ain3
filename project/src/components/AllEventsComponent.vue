...
const fetchEvents = async () => {
  loading.value = true
  try {
    const response = await authFetch('https://ec2-16-171-142-19.eu-north-1.compute.amazonaws.com:8000/allEvents')
...
const confirmDeleteEvent = async () => {
  ...
  try {
    const response = await authFetch('https://ec2-16-171-142-19.eu-north-1.compute.amazonaws.com:8000/delete-event', {
      method: 'POST',
