...
const fetchLogs = async () => {
  loading.value = true
  try {
    const response = await authFetch('https://wealthy-current-cat.ngrok-free.app/logs')
...
const confirmDeleteLogs = async () => {
  try {
    const response = await authFetch('https://wealthy-current-cat.ngrok-free.app/clear-logs', {
      method: 'POST',
    })
